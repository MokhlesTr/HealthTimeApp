...
import MyDoctorProfil from "./MyDocProfil";
...
const MySearch = () => {
  ...
  const handleDoctorClick = (doctor) => {
    ...
    console.log(doctor);
    setDoctor(doctor);
    localStorage.setItem("DoctorStorage", JSON.stringify(doctor));
  };
    ...
    >
      <div className="lg:container mx-auto px-4 py-40 min-h-screen">
        {!profil ? (
            ...
            <div className="flex justify-between items-center lg:flex-row flex-col">
              <div className="text-white">
                ...
                <p className="text-gray-600 mb-8 flex-row lg:ml-14 w-96 flex flex-wrap">
                  Please enter the doctor's name and, if necessary, filter by
                  city and specialty. <br />
                  Then click on
              ...
              {filteredDoctors.length > 0 && (
                <ul className="flex space-x-2">
                  {Array.from(
                    ...
                    }, // Use doctorsPerPage instead of 12
                    (_, i) => (
                      <li key={i}>
                        <button
                          className={`px-4 py-2 rounded-lg font-medium ${
                            currentPage === i + 1
                              ? "bg-white text-blue-500 border-sky-200 font-semibold border-4"
                              : "bg-neutral-400 text-white border-neutral-400 border-4"
                          }`}
          ...
          <MyDoctorProfil setProfil={setProfil} doctor={doctor} />
        )}
      </div>
    </div>
  );
